...
## function __downsample__\(series, by, fnc=<function nanmean at 0x7f5c8509a158>\)
...
- `fnc` -- The function to average the samples that are combined into 1 value. Typically an average or a median.
	- Type: callable
	- Default: <function nanmean at 0x7f5c8509a158>
...
## function __reduce\___\(series, operation=<function nanmean at 0x7f5c8509a158>\)
